        ...
        <div class="form-container bg-white">
            ...
            <form id="multiStepForm" action="{{ route('alumni.form.submit') }}" method="POST" class="space-y-6 p-6">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    <button type="button" id="resetBtn" class="text-gray-500 hover:text-red-600 font-medium transition flex items-center">
                    ...
                    <div class="flex gap-3">
                        <button type="button" id="prevBtn" class="hidden bg-white border border-gray-300 text-gray-700 px-5 py-2.5 rounded-lg font-medium hover:bg-gray-50 transition">
                        ...
                        <button type="button" id="nextBtn" class="btn-primary text-white px-6 py-2.5 rounded-lg font-medium">
                            <div class="flex items-center">
                                Berikutnya
                        ...
                        <button type="submit" id="submitBtn" class="hidden bg-green-600 hover:bg-green-700 text-white px-6 py-2.5 rounded-lg font-medium transition">
                            Kirim Formulir
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-red-50 border-l-4 border-red-400 p-4 mt-6">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">Terdapat {{ $errors->count() }} error dalam pengisian form:</h3>
